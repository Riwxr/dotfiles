...
Singleton {
    ...
    readonly property int fast:     Math.round(60 * mult)
    readonly property int standard: Math.round(100 * mult)
    readonly property int morph:    Math.round(120 * mult)
    readonly property int shapeshift: Math.round(820 * mult)
    readonly property int glide:    Math.round(60 * mult)
